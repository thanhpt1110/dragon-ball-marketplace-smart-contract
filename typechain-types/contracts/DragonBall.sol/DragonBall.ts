...
export interface DragonBallInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface DragonBall extends BaseContract {
  connect(runner?: ContractRunner | null): DragonBall;
  waitForDeployment(): Promise<this>;

  interface: DragonBallInterface;
  ...
  listTokenIds: TypedContractMethod<[owner: AddressLike], [bigint[]], "view">;
  ...
  setBaseUrl: TypedContractMethod<[_newUrl: string], [void], "nonpayable">;
