...
export declare namespace TestMarketplace {
...
export interface TestMarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "buyNft"
      | "getListedNft"
...
export interface TestMarketplace extends BaseContract {
  connect(runner?: ContractRunner | null): TestMarketplace;
  ...
  getListedNft: TypedContractMethod<
    [],
    [TestMarketplace.ListDetailStructOutput[]],
    "view"
  >;
